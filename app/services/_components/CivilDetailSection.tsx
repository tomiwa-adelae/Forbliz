...
export const CivilDetailSection = () => {
  return (
    <section id="civil" className="py-24 bg-slate-50 overflow-hidden">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              ...
              complex highway links to industrial-grade site grading, our civil
              engineering team ensures every project meets rigorous structural
              integrity standards.
            </p>
