      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 uppercase italic leading-tight">
                Zero Downtime <br className="hidden lg:block" />
                <span className="text-slate-400">Philosophy.</span>
              </h3>
              <p className="text-slate-600 mt-2.5 text-lg leading-relaxed">
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-900 rounded-[3rem] p-8 md:p-10 text-white shadow-2xl">
